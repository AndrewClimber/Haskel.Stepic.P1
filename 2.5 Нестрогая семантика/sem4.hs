...
1.Любая лямбда-абстракция \x -> x + 2*3  - редекс находится за пределом лямбда-абстракции. Т.е. внутри лямбда-функции
2.Конструктор данных (3, 1+5) - редекс за барьером конструктора
3.Конструктор данных может быть частично применен (,) (4*5) - редекс за барьером конструктора данных
